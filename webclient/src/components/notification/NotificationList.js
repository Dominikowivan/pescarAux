...
const rows = [
    ...
    { id: 'subject', numeric: false, disablePadding: false, label: 'Asunto' },
    { id: 'description', numeric: false, disablePadding: false, label: 'Descripción' },
    { id: 'createdDate', numeric: false, disablePadding: false, label: 'Fecha creación' },
];
            ...
            <div className={classes.title}>
                {numSelected > 0 ? (
                    <Typography color="inherit" variant="subtitle1">
                        {numSelected} notificaciones selecionadas
          </Typography>
                ) : (
